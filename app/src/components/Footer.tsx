      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 items-center">
          ...
          <div className="text-center md:text-left">
            <div className="font-mono text-[15px] text-text mb-1.5">
              <span className="text-terminal-green">~</span>
              <span className="text-text-dim">/</span>
              <span>{t.footer.title.toLowerCase().replace(/\./g, '')}</span>
          ...
          {/* Right: Built with */}
          <div className="text-center md:text-right font-mono text-[12px] text-text-dim">
          {t.footer.builtWith}{' '}
            <span className="text-hud-purple">.NET 10</span>
            <span className="text-text-dim"> & </span>
        ...
        <div className="text-center pt-6" style={{ borderTop: '1px solid rgba(30, 42, 56, 0.6)' }}>
